...
## Resultado:
```bash
Data Frame creado con éxito.

- - - Análisis de sucursales - - -
  sucursal  ventas  gastos  beneficio
0    Norte   25000   18000       7000
1      Sur   32000   35000      -3000
2     Este   15000   12000       3000
3    Oeste   40000   22000      18000
Sucursales que requieren una revisión: ['Sur']
```